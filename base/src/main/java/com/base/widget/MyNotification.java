 ...
 * on 2016-06-14
 * 12:53
 * Procedure Explain:仿魅族的Notification
 */
public class MyNotification implements View.OnTouchListener {
    ...
    public MyNotification(Builder builder) {
    ...
    public static class Builder {
        ...
        public MyNotification build() {
            ...
            return new MyNotification(this);
        }
